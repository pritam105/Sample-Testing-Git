...
public class SparseSpreadSheetTest {
  ...
  /**
   * Tests the get and set methods of the SparseSpreadSheet.
   */
  @Test
  ...
  /**
   * Tests the getWidth and getHeight methods of the SparseSpreadSheet.
   */
  ...
  /**
   * Tests the get method of the SparseSpreadSheet with a negative row index.
   */
  ...
  /**
   * Tests the get method of the SparseSpreadSheet with a negative column index.
   */
  @Test(expected = IllegalArgumentException.class)
